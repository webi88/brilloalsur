...
const socialPosts = [
  {
    ...
    handle: "@brilloalsur",
    content:
      "El sur de Quintana Roo tiene todo para convertirse en un polo de desarrollo sustentable. ¡Únete al movimiento! 🌿",
    likes: 234,
    shares: 45,
    date: "Hace 2 horas",
  },
  {
    ...
    handle: "@brilloalsur",
    content:
      "¿Sabías que Bacalar es uno de los destinos con mayor potencial turístico sustentable en todo México? �️ #BrilloAlSur",
    likes: 1520,
    shares: 312,
    date: "Hace 5 horas",
  },
  ...
  },
  {
    ...
    handle: "@brilloalsur",
    content:
      "El rezago histórico del sur de QRoo no es destino, es una deuda pendiente. Hoy trabajamos para saldarla con desarrollo real y justo. #BrilloAlSur",
    likes: 456,
    shares: 123,
    date: "Hace 3 horas",
  },
