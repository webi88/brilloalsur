...
export default function NoticiasPage() {
  ...
  // Only show featured layout when no filter/search is active
                  ...
                  <Link href={`/noticias/${featured.slug}`} className="group block">
                    <div className="grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden shadow-xl bg-white">
                      ...
                      <div className="p-8 lg:p-12 flex flex-col justify-center">
                        ...
                        <h2 className="text-2xl lg:text-3xl font-heading font-bold text-gray-900 mb-4 group-hover:text-olive-700 transition-colors leading-snug">
                          {featured.title}
                        </h2>
                    ...
                    >
                      <Link href={`/noticias/${post.slug}`} className="group block bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all h-full">
                        ...
                        <div className="p-5">
                          ...
                          <h3 className="font-heading font-bold text-gray-900 text-lg mb-2 group-hover:text-olive-700 transition-colors line-clamp-2 leading-snug">
                            {post.title}
                          </h3>
